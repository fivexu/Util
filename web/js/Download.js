...
class StreamDownload {
  ...
  /** 下载文件函数
   * @param {Object} option 下载文件配置设置
   * @param {String} option.downloadDir  存储位置 绝对路劲
   * @param {String} option.downloadFileUrl  下载请求路径 http
   * @param {String} option.filenName 下载文件名 可不填
   * @param {String} option.method 下载请求方式 可不填 默认GET 可填post
   * @param {Object} option.data post下可用 需要post的参数
   */
